...
const STORAGE_URL = import.meta.env.VITE_STORAGE_URL || 'http://localhost:5000/storage/products-pictures';
const PROFILE_PICTURE_URL = import.meta.env.VITE_PROFILE_PICTURE_URL || 'http://localhost:5000';
